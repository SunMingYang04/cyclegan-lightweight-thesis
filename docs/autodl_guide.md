...
Formal thesis runs should keep `batch_size=1` and `use_amp=false`. The default configs are optimized for RTX 4080 SUPER with `num_workers=8`, `pin_memory=true`, `persistent_workers=true`, and `prefetch_factor=4`.
